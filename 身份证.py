...
print("本程序仅供第二代身份证查询，如需查询第一代请自行百度")
# id_long=0
id=input("请输入身份证号:")
while(len(id)!=18): # 判断身份证输入是否正确，且前6位存在list_id_city组中
    print("输入有误请重新输入")
    id=input("请输入身份证号:")
# 进度条开始
scale = 10
print("-------正在查询中--------".center(scale // 2, "-"))
...
for i in range(scale + 1):
    ...
    time.sleep(0.1)
print("\n" + "查询结果如下:".center(scale // 2, "-"))
# 进度条结束
id_city=id[0:6]# 获取输入身份证号前六位
city=list_id_city.index(id_city)# 获取身份证前六位在组里的位置值
print("你的的户籍所在地为:{}。".format(list_id_city[city+1])+"你的户籍代码为:"+format(id_city))
id_birthday=id[6:14]# 获取身份证中的7到14位
id_birthday_year=id_birthday[0:4]# 获取id_birthday数据的1到4位
id_birthday_month=id_birthday[4:6]# 获取id_birthday数据的5到6位
id_birthday_day=id_birthday[6:8]# 获取id_birthday数据的7到8位
print("你的生日为{}年{}月{}日".format(id_birthday_year,id_birthday_month,id_birthday_day))
id_gender=id[-2]
if(int(id_gender)%2!=0):# 通过除2判断是奇数还是偶数
    print("你的性别为男")
else:
    print("你的性别为女")
